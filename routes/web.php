...
Route::get("/user/{name}", [UserController::class, 'show'],function($name){});
...
Route::get("/about",function(){ return show('pages.about');})->name('about');
...
Route::group(['prefix'=>'admin'],fucntion()
             {
